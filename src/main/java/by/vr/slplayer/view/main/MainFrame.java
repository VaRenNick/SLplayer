...
import static by.vr.slplayer.Application.resources;
...
import by.vr.slplayer.event.PausedEvent;
import by.vr.slplayer.event.PlayingEvent;
import by.vr.slplayer.event.ShowDebugEvent;
import by.vr.slplayer.event.ShowEffectsEvent;
import by.vr.slplayer.event.ShowMessagesEvent;
import by.vr.slplayer.event.SnapshotImageEvent;
import by.vr.slplayer.event.StoppedEvent;
import by.vr.slplayer.view.BaseFrame;
import by.vr.slplayer.view.MouseMovementDetector;
import by.vr.slplayer.view.action.StandardAction;
import by.vr.slplayer.view.action.mediaplayer.MediaPlayerActions;
import by.vr.slplayer.view.snapshot.SnapshotView;
